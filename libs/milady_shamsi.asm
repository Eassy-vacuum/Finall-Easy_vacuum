...
;libs/milady_shamsi.mbas,53 :: 		seconds  =  ((seconds and 0xF0) >> 4)*10 + (seconds and 0x0F)  ' Transform seconds
	LDS        R16, _seconds+0
	ANDI       R16, 240
	MOV        R17, R16
	LSR        R17
	...
	ADD        R16, R17
	STS        _seconds+0, R16
;libs/milady_shamsi.mbas,54 :: 		minutes  =  ((minutes and 0xF0) >> 4)*10 + (minutes and 0x0F)
	LDS        R16, _minutes+0
	ANDI       R16, 240
	MOV        R17, R16
	LSR        R17
	...
	ADD        R16, R17
	STS        _minutes+0, R16
;libs/milady_shamsi.mbas,56 :: 		hours    =  ((hours and 0xF0) >> 4)*10 + (hours and 0x0F)
	LDS        R16, _hours+0
	ANDI       R16, 240
	MOV        R17, R16
	LSR        R17
	...
	ADD        R16, R17
	STS        _hours+0, R16
;libs/milady_shamsi.mbas,57 :: 		week     =  (week and 0x07)
	LDS        R16, _week+0
	ANDI       R16, 7
	STS        _week+0, R16
;libs/milady_shamsi.mbas,58 :: 		day      =  ((day and 0xF0) >> 4)*10 + (day and 0x0F)
	LDS        R16, _day+0
	ANDI       R16, 240
	MOV        R17, R16
	LSR        R17
	...
	ADD        R16, R17
	STS        _day+0, R16
;libs/milady_shamsi.mbas,59 :: 		month    =  ((month and 0x10) >> 4)*10 + (month and 0x0F)
	LDS        R16, _month+0
	ANDI       R16, 16
	MOV        R17, R16
	LSR        R17
	...
	ADD        R16, R17
	STS        _month+0, R16
;libs/milady_shamsi.mbas,60 :: 		year     =  ((year and 0xF0) >> 4)*10+(year and 0x0F)
	LDS        R16, _year+0
	ANDI       R16, 240
	MOV        R17, R16
	LSR        R17
	...
	ADD        R16, R17
	STS        _year+0, R16
;libs/milady_shamsi.mbas,61 :: 		end sub
...
;libs/milady_shamsi.mbas,65 :: 		sub procedure Shamsi_show_lcd(dim jjmonth,jjday,jjyear,jweek,jhours ,jminutes,jseconds as integer)
	PUSH       R2
	PUSH       R3
	PUSH       R4
	PUSH       R5
...
;libs/milady_shamsi.mbas,83 :: 		LCD_Out(1,1, txt)
	...
	POP        R4
	POP        R5
;libs/milady_shamsi.mbas,84 :: 		Lcd_Chr(1, 6, (jjday div 10)   + 48)    ' Print tens digit of day variable
	PUSH       R5
	PUSH       R4
	PUSH       R3
	PUSH       R2
	...
	POP        R4
	POP        R5
;libs/milady_shamsi.mbas,85 :: 		Lcd_Chr(1, 7, (jjday mod 10)   + 48)    ' Print oness digit of day variable
	PUSH       R3
	PUSH       R2
	LDI        R20, 10
	LDI        R21, 0
	...
	POP        R2
	POP        R3
;libs/milady_shamsi.mbas,86 :: 		Lcd_Chr(1, 9, (jjmonth div 10) + 48)
	PUSH       R3
	PUSH       R2
	LDI        R20, 10
	LDI        R21, 0
	...
	POP        R2
	POP        R3
;libs/milady_shamsi.mbas,87 :: 		Lcd_Chr(1,10, (jjmonth mod 10) + 48)
	LDI        R20, 10
	LDI        R21, 0
	MOVW       R16, R2
	CALL       _Div_16x16_S+0
	...
	POP        R6
	POP        R7
;libs/milady_shamsi.mbas,89 :: 		Lcd_Chr(1,12, (jjyear div 1000)  + 48)
	PUSH       R7
	PUSH       R6
	LDI        R20, 232
	LDI        R21, 3
	...
	POP        R6
	POP        R7
;libs/milady_shamsi.mbas,90 :: 		Lcd_Chr(1,13, ((jjyear mod 1000)div 100)  + 48)
	PUSH       R7
	PUSH       R6
	LDI        R20, 232
	LDI        R21, 3
	...
	POP        R6
	POP        R7
;libs/milady_shamsi.mbas,91 :: 		Lcd_Chr(1,14, (((jjyear mod 1000)mod 100) div 10)  + 48)
	PUSH       R7
	PUSH       R6
	LDI        R20, 232
	LDI        R21, 3
	...
	POP        R6
	POP        R7
;libs/milady_shamsi.mbas,92 :: 		Lcd_Chr(1,15, (((jjyear mod 1000)mod 100) mod 10)  + 48)
	LDI        R20, 232
	LDI        R21, 3
	MOVW       R16, R6
	CALL       _Div_16x16_S+0
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,94 :: 		Lcd_Chr(2, 6, (jhours div 10)   + 48)
	LDI        R20, 10
	LDI        R21, 0
	LDD        R16, Y+0
	LDD        R17, Y+1
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,95 :: 		Lcd_Chr(2, 7, (jhours mod 10)   + 48)
	LDI        R20, 10
	LDI        R21, 0
	LDD        R16, Y+0
	LDD        R17, Y+1
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,96 :: 		Lcd_Chr(2, 9, (jminutes div 10) + 48)
	LDI        R20, 10
	LDI        R21, 0
	LDD        R16, Y+2
	LDD        R17, Y+3
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,97 :: 		Lcd_Chr(2,10, (jminutes mod 10) + 48)
	LDI        R20, 10
	LDI        R21, 0
	LDD        R16, Y+2
	LDD        R17, Y+3
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,98 :: 		Lcd_Chr(2,12, (jseconds div 10) + 48)
	LDI        R20, 10
	LDI        R21, 0
	LDD        R16, Y+4
	LDD        R17, Y+5
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,99 :: 		Lcd_Chr(2,13, (jseconds mod 10) + 48)
	LDI        R20, 10
	LDI        R21, 0
	LDD        R16, Y+4
	LDD        R17, Y+5
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,101 :: 		end sub
...
;libs/milady_shamsi.mbas,114 :: 		end structure
;libs/milady_shamsi.mbas,116 :: 		Mmonth_a[0] = 30
	LDI        R27, 30
	STD        Y+8, R27
;libs/milady_shamsi.mbas,117 :: 		Mmonth_a[1] = 31
	LDI        R27, 31
	STD        Y+9, R27
;libs/milady_shamsi.mbas,118 :: 		Mmonth_a[2] = 30
	LDI        R27, 30
	STD        Y+10, R27
;libs/milady_shamsi.mbas,119 :: 		Mmonth_a[3] = 31
	LDI        R27, 31
	STD        Y+11, R27
;libs/milady_shamsi.mbas,120 :: 		Mmonth_a[4] = 31
	LDI        R27, 31
	STD        Y+12, R27
;libs/milady_shamsi.mbas,121 :: 		Mmonth_a[5] = 30
	LDI        R27, 30
	STD        Y+13, R27
;libs/milady_shamsi.mbas,122 :: 		Mmonth_a[6] = 31
	LDI        R27, 31
	STD        Y+14, R27
;libs/milady_shamsi.mbas,123 :: 		Mmonth_a[7] = 30
	LDI        R27, 30
	STD        Y+15, R27
;libs/milady_shamsi.mbas,124 :: 		Mmonth_a[8] = 31
	LDI        R27, 31
	STD        Y+16, R27
;libs/milady_shamsi.mbas,125 :: 		Mmonth_a[9] = 31
	LDI        R27, 31
	STD        Y+17, R27
;libs/milady_shamsi.mbas,126 :: 		Mmonth_a[10] = 28
	LDI        R27, 28
	STD        Y+18, R27
;libs/milady_shamsi.mbas,127 :: 		Mmonth_a[11] = 31
	LDI        R27, 31
	STD        Y+19, R27
;libs/milady_shamsi.mbas,129 :: 		miladiYear = ShamsiYear + 621
	MOVW       R16, R6
	SUBI       R16, 147
	SBCI       R17, 253
	STD        Y+2, R16
	STD        Y+3, R17
;libs/milady_shamsi.mbas,130 :: 		miladiYear2=miladiYear
	STD        Y+0, R16
	STD        Y+1, R17
;libs/milady_shamsi.mbas,131 :: 		Temp1 = miladiYear2 Mod 4
	PUSH       R5
	PUSH       R4
	PUSH       R3
	PUSH       R2
	...
	STS        _Temp1+0, R16
	STS        _Temp1+1, R17
;libs/milady_shamsi.mbas,132 :: 		Temp2 = miladiYear2 Mod 100
	LDI        R20, 100
	LDI        R21, 0
	LDD        R16, Y+0
	LDD        R17, Y+1
	...
	STS        _Temp2+0, R16
	STS        _Temp2+1, R17
;libs/milady_shamsi.mbas,133 :: 		Temp3 = miladiYear2 Mod 400
	LDI        R20, 144
	LDI        R21, 1
	LDD        R16, Y+0
	LDD        R17, Y+1
	...
	STS        _Temp3+0, R16
	STS        _Temp3+1, R17
;libs/milady_shamsi.mbas,134 :: 		Temp4 = (( Temp2 <> 0) and ( Temp1 = 0) )
	LDS        R21, _Temp2+0
	LDS        R22, _Temp2+1
	CPI        R22, 0
...
L_libs/milady_shamsi_shamsi_to_milady123:
	...
	LDI        R27, 0
	STS        _Temp4+1, R27
;libs/milady_shamsi.mbas,135 :: 		Temp5=((Temp2 = 0) and (Temp3 = 0) )
	CPI        R22, 0
...
; Temp5 start address is: 18 (R18)
	MOV        R18, R16
	LDI        R19, 0
;libs/milady_shamsi.mbas,137 :: 		if(Temp4 or temp5) then
	LDS        R16, _Temp4+0
	LDS        R17, _Temp4+1
	OR         R16, R18
	OR         R17, R19
...
;libs/milady_shamsi.mbas,142 :: 		marchDayDiff = 12
	LDI        R27, 12
	STD        Y+4, R27
	LDI        R27, 0
	STD        Y+5, R27
	JMP        L_libs/milady_shamsi_shamsi_to_milady27
;libs/milady_shamsi.mbas,143 :: 		Else
L_libs/milady_shamsi_shamsi_to_milady26:
;libs/milady_shamsi.mbas,146 :: 		marchDayDiff = 11
	LDI        R27, 11
	STD        Y+4, R27
	LDI        R27, 0
	STD        Y+5, R27
;libs/milady_shamsi.mbas,147 :: 		End If
L_libs/milady_shamsi_shamsi_to_milady27:
;libs/milady_shamsi.mbas,148 :: 		if(((((miladiYear+1 mod  100)<> 0) and ((miladiYear+1 mod 4) = 0))) or ((((miladiYear+1 mod 100)= 0) and (miladiYear+1 mod 400) = 0))) then
	LDD        R16, Y+2
	LDD        R17, Y+3
	MOV        R19, R16
	MOV        R20, R17
...
;libs/milady_shamsi.mbas,150 :: 		Mmonth_a[10] = Mmonth_a[10] + 1 '//Adding one day to Feb
	LDD        R16, Y+18
	SUBI       R16, 255
	STD        Y+18, R16
L_libs/milady_shamsi_shamsi_to_milady29:
;libs/milady_shamsi.mbas,153 :: 		if((ShamsiMonth>=1)and( ShamsiMonth<=6))   then
	LDI        R16, 1
	LDI        R17, 0
	CP         R2, R16
	CPC        R3, R17
...
;libs/milady_shamsi.mbas,154 :: 		dayCount = ((ShamsiMonth-1) * 31) + ShamsiDay
	MOVW       R16, R2
	SUBI       R16, 1
	SBCI       R17, 0
	LDI        R20, 31
...
;libs/milady_shamsi.mbas,155 :: 		else
L_libs/milady_shamsi_shamsi_to_milady32:
;libs/milady_shamsi.mbas,156 :: 		dayCount =(6 * 31) + ((ShamsiMonth - 7) * 30) + ShamsiDay
	MOVW       R16, R2
	SUBI       R16, 7
	SBCI       R17, 0
	LDI        R20, 30
...
; dayCount start address is: 18 (R18)
	MOVW       R18, R16
; dayCount end address is: 18 (R18)
;libs/milady_shamsi.mbas,157 :: 		end if
L_libs/milady_shamsi_shamsi_to_milady33:
;libs/milady_shamsi.mbas,158 :: 		if (dayCount <= marchDayDiff) then '//So we are in 20(for leap year) or 21for none leap year) to 31 march
; dayCount start address is: 18 (R18)
	LDD        R16, Y+4
	LDD        R17, Y+5
	CP         R16, R18
...
;libs/milady_shamsi.mbas,160 :: 		miladiDate_iDay = dayCount + (31 - marchDayDiff)
	LDD        R0, Y+4
	LDD        R1, Y+5
	LDI        R16, 31
	LDI        R17, 0
...
;libs/milady_shamsi.mbas,161 :: 		miladiDate_iMonth = 3
	LDI        R27, 3
	STS        _miladiDate_iMonth+0, R27
	LDI        R27, 0
	STS        _miladiDate_iMonth+1, R27
;libs/milady_shamsi.mbas,162 :: 		miladiDate_iYear=miladiYear
	LDD        R16, Y+2
	LDD        R17, Y+3
	STS        _miladiDate_iYear+0, R16
	STS        _miladiDate_iYear+1, R17
	JMP        L_libs/milady_shamsi_shamsi_to_milady36
;libs/milady_shamsi.mbas,164 :: 		else
L_libs/milady_shamsi_shamsi_to_milady35:
;libs/milady_shamsi.mbas,165 :: 		remainDay = dayCount - marchDayDiff
; dayCount start address is: 18 (R18)
	LDD        R0, Y+4
	LDD        R1, Y+5
	MOVW       R16, R18
...
; dayCount end address is: 18 (R18)
	STD        Y+6, R16
	STD        Y+7, R17
;libs/milady_shamsi.mbas,166 :: 		end if
L_libs/milady_shamsi_shamsi_to_milady36:
;libs/milady_shamsi.mbas,167 :: 		i = 0  ' //starting from April
; i start address is: 20 (R20)
	LDI        R20, 0
	LDI        R21, 0
; i end address is: 20 (R20)
;libs/milady_shamsi.mbas,169 :: 		while ((remainDay > Mmonth_a[i]))
...
;libs/milady_shamsi.mbas,171 :: 		remainDay = remainDay - Mmonth_a[i]
	MOVW       R16, R28
	SUBI       R16, 248
	SBCI       R17, 255
	MOVW       R30, R20
	...
	STD        Y+6, R16
	STD        Y+7, R17
;libs/milady_shamsi.mbas,172 :: 		i=i+1
	MOVW       R16, R20
	SUBI       R16, 255
	SBCI       R17, 255
; i end address is: 20 (R20)
; i start address is: 22 (R22)
	MOVW       R22, R16
;libs/milady_shamsi.mbas,174 :: 		wend
	MOVW       R20, R22
; i end address is: 22 (R22)
	JMP        L_libs/milady_shamsi_shamsi_to_milady38
L_libs/milady_shamsi_shamsi_to_milady39:
;libs/milady_shamsi.mbas,175 :: 		miladiDate_iDay = remainDay
; i start address is: 20 (R20)
	LDD        R16, Y+6
	LDD        R17, Y+7
	STS        _miladiDate_iDay+0, R16
	STS        _miladiDate_iDay+1, R17
;libs/milady_shamsi.mbas,177 :: 		if (i > 8)  then '// We are in the next Miladi Year
	LDI        R16, 8
	LDI        R17, 0
	CP         R16, R20
	CPC        R17, R21
...
;libs/milady_shamsi.mbas,179 :: 		miladiDate_iMonth = i - 8
	MOVW       R16, R20
	SUBI       R16, 8
	SBCI       R17, 0
; i end address is: 20 (R20)
...
;libs/milady_shamsi.mbas,180 :: 		miladiDate_iYear =  miladiYear + 1
	LDD        R16, Y+2
	LDD        R17, Y+3
	SUBI       R16, 255
	SBCI       R17, 255
...
;libs/milady_shamsi.mbas,182 :: 		else
L_libs/milady_shamsi_shamsi_to_milady43:
;libs/milady_shamsi.mbas,184 :: 		miladiDate_iMonth = i + 4
; i start address is: 20 (R20)
	MOVW       R16, R20
	SUBI       R16, 252
	SBCI       R17, 255
; i end address is: 20 (R20)
	STS        _miladiDate_iMonth+0, R16
	STS        _miladiDate_iMonth+1, R17
;libs/milady_shamsi.mbas,185 :: 		miladiDate_iYear =  miladiYear
	LDD        R16, Y+2
	LDD        R17, Y+3
	STS        _miladiDate_iYear+0, R16
	STS        _miladiDate_iYear+1, R17
;libs/milady_shamsi.mbas,186 :: 		end if
L_libs/milady_shamsi_shamsi_to_milady44:
;libs/milady_shamsi.mbas,189 :: 		end sub
...
;libs/milady_shamsi.mbas,193 :: 		sub procedure shamsi()
;libs/milady_shamsi.mbas,197 :: 		Gmonth_a[0] = 31
	LDI        R27, 31
	STS        _Gmonth_a+0, R27
;libs/milady_shamsi.mbas,198 :: 		Gmonth_a[1] = 28
	LDI        R27, 28
	STS        _Gmonth_a+1, R27
;libs/milady_shamsi.mbas,199 :: 		Gmonth_a[2] = 31
	LDI        R27, 31
	STS        _Gmonth_a+2, R27
;libs/milady_shamsi.mbas,200 :: 		Gmonth_a[3] = 30
	LDI        R27, 30
	STS        _Gmonth_a+3, R27
;libs/milady_shamsi.mbas,201 :: 		Gmonth_a[4] = 31
	LDI        R27, 31
	STS        _Gmonth_a+4, R27
;libs/milady_shamsi.mbas,202 :: 		Gmonth_a[5] = 30
	LDI        R27, 30
	STS        _Gmonth_a+5, R27
;libs/milady_shamsi.mbas,203 :: 		Gmonth_a[6] = 31
	LDI        R27, 31
	STS        _Gmonth_a+6, R27
;libs/milady_shamsi.mbas,204 :: 		Gmonth_a[7] = 31
	LDI        R27, 31
	STS        _Gmonth_a+7, R27
;libs/milady_shamsi.mbas,205 :: 		Gmonth_a[8] = 30
	LDI        R27, 30
	STS        _Gmonth_a+8, R27
;libs/milady_shamsi.mbas,206 :: 		Gmonth_a[9] = 31
	LDI        R27, 31
	STS        _Gmonth_a+9, R27
;libs/milady_shamsi.mbas,207 :: 		Gmonth_a[10] = 30
	LDI        R27, 30
	STS        _Gmonth_a+10, R27
;libs/milady_shamsi.mbas,208 :: 		Gmonth_a[11] = 31
	LDI        R27, 31
	STS        _Gmonth_a+11, R27
;libs/milady_shamsi.mbas,209 :: 		Gnumdayofyear = 365
	LDI        R27, 109
	STS        _Gnumdayofyear+0, R27
	LDI        R27, 1
	STS        _Gnumdayofyear+1, R27
;libs/milady_shamsi.mbas,210 :: 		Gdayofyear = 0
	LDI        R27, 0
	STS        _Gdayofyear+0, R27
	STS        _Gdayofyear+1, R27
;libs/milady_shamsi.mbas,211 :: 		Temp1 = Gyear Mod 4
	LDI        R20, 4
	LDI        R21, 0
	LDS        R16, _Gyear+0
	LDS        R17, _Gyear+1
	...
	STS        _Temp1+0, R16
	STS        _Temp1+1, R17
;libs/milady_shamsi.mbas,212 :: 		Temp2 = Gyear Mod 100
	LDI        R20, 100
	LDI        R21, 0
	LDS        R16, _Gyear+0
	LDS        R17, _Gyear+1
	...
	STS        _Temp2+0, R16
	STS        _Temp2+1, R17
;libs/milady_shamsi.mbas,213 :: 		Temp3 = Gyear Mod 400
	LDI        R20, 144
	LDI        R21, 1
	LDS        R16, _Gyear+0
	LDS        R17, _Gyear+1
	...
	STS        _Temp3+0, R16
	STS        _Temp3+1, R17
;libs/milady_shamsi.mbas,214 :: 		Temp4 = Temp1 And Temp2
	LDS        R20, _Temp1+0
	LDS        R21, _Temp1+1
	LDS        R18, _Temp2+0
	LDS        R19, _Temp2+1
	...
	STS        _Temp4+0, R18
	STS        _Temp4+1, R19
;libs/milady_shamsi.mbas,215 :: 		If (Temp4 <> 0) Or (Temp3 = 0) Then
	CPI        R19, 0
...
;libs/milady_shamsi.mbas,217 :: 		Gmonth_a[1] = 28
	LDI        R27, 28
	STS        _Gmonth_a+1, R27
	JMP        L_libs/milady_shamsi_shamsi48
;libs/milady_shamsi.mbas,218 :: 		Else
L_libs/milady_shamsi_shamsi47:
;libs/milady_shamsi.mbas,219 :: 		Gmonth_a[1] = 29
	LDI        R27, 29
	STS        _Gmonth_a+1, R27
;libs/milady_shamsi.mbas,220 :: 		End If
L_libs/milady_shamsi_shamsi48:
;libs/milady_shamsi.mbas,223 :: 		Gyear_ = Gyear - 1
	LDS        R16, _Gyear+0
	LDS        R17, _Gyear+1
	SUBI       R16, 1
	SBCI       R17, 0
	STS        _Gyear_+0, R16
	STS        _Gyear_+1, R17
;libs/milady_shamsi.mbas,224 :: 		Temp1 = Gyear_ Mod 4
	LDI        R20, 4
	LDI        R21, 0
	CALL       _Div_16x16_S+0
	MOVW       R16, R24
	STS        _Temp1+0, R16
	STS        _Temp1+1, R17
;libs/milady_shamsi.mbas,225 :: 		Temp2 = Gyear_ Mod 100
	LDI        R20, 100
	LDI        R21, 0
	LDS        R16, _Gyear_+0
	LDS        R17, _Gyear_+1
	...
	STS        _Temp2+0, R16
	STS        _Temp2+1, R17
;libs/milady_shamsi.mbas,226 :: 		Temp3 = Gyear_ Mod 400
	LDI        R20, 144
	LDI        R21, 1
	LDS        R16, _Gyear_+0
	LDS        R17, _Gyear_+1
	...
	STS        _Temp3+0, R16
	STS        _Temp3+1, R17
;libs/milady_shamsi.mbas,227 :: 		Temp4 = Temp1 And Temp2
	LDS        R20, _Temp1+0
	LDS        R21, _Temp1+1
	LDS        R18, _Temp2+0
	LDS        R19, _Temp2+1
	...
	STS        _Temp4+0, R18
	STS        _Temp4+1, R19
;libs/milady_shamsi.mbas,228 :: 		If (Temp4 <> 0) Or (Temp3 = 0) Then
	CPI        R19, 0
...
;libs/milady_shamsi.mbas,233 :: 		Temp1 = Gmonth - 1
	...
	STS        _Temp1+0, R16
	STS        _Temp1+1, R17
;libs/milady_shamsi.mbas,234 :: 		For Iloop = 1 To Temp1
	LDI        R27, 1
	STS        _Iloop+0, R27
...
;libs/milady_shamsi.mbas,235 :: 		Gdayofyear = Gmonth_a[iloop-1] + Gdayofyear
	LDS        R18, _Iloop+0
	SUBI       R18, 1
...
;libs/milady_shamsi.mbas,236 :: 		Next   Iloop
	LDS        R16, _Iloop+0
	LDS        R18, _Temp1+0
	LDS        R19, _Temp1+1
	LDI        R17, 0
...
;libs/milady_shamsi.mbas,237 :: 		Gdayofyear = Gday + Gdayofyear
	LDS        R18, _Gday+0
	LDS        R19, _Gday+1
	LDS        R16, _Gdayofyear+0
	LDS        R17, _Gdayofyear+1
...
;libs/milady_shamsi.mbas,238 :: 		If Gdayofyear > 79 Then
	LDI        R16, 79
	LDI        R17, 0
	CP         R16, R18
	CPC        R17, R19
...
;libs/milady_shamsi.mbas,239 :: 		Temp1 = Gdayofyear - 79
	...
	STS        _Temp1+0, R18
	STS        _Temp1+1, R19
;libs/milady_shamsi.mbas,240 :: 		Jyear = Gyear - 621
	LDS        R16, _Gyear+0
	LDS        R17, _Gyear+1
	SUBI       R16, 109
	SBCI       R17, 2
	STS        _Jyear+0, R16
	STS        _Jyear+1, R17
;libs/milady_shamsi.mbas,241 :: 		If Temp1 < 186 Then
	LDI        R16, 186
	LDI        R17, 0
	CP         R18, R16
	CPC        R19, R17
...
;libs/milady_shamsi.mbas,242 :: 		Temp2 = Temp1 Mod 31
	LDI        R20, 31
	LDI        R21, 0
	LDS        R16, _Temp1+0
	LDS        R17, _Temp1+1
	...
	STS        _Temp2+0, R16
	STS        _Temp2+1, R17
;libs/milady_shamsi.mbas,243 :: 		Temp3 = Temp1 / 31
	LDI        R20, 31
	LDI        R21, 0
	LDS        R16, _Temp1+0
	LDS        R17, _Temp1+1
	...
	STS        _Temp3+0, R16
	STS        _Temp3+1, R17
;libs/milady_shamsi.mbas,244 :: 		If Temp2 = 0 Then
	LDS        R16, _Temp2+0
	LDS        R17, _Temp2+1
	CPI        R17, 0
...
;libs/milady_shamsi.mbas,245 :: 		Jmonth = Temp3
	LDS        R16, _Temp3+0
	LDS        R17, _Temp3+1
	STS        _Jmonth+0, R16
	STS        _Jmonth+1, R17
;libs/milady_shamsi.mbas,246 :: 		Jday = 31
	LDI        R27, 31
	STS        _Jday+0, R27
	LDI        R27, 0
	STS        _Jday+1, R27
...
;libs/milady_shamsi.mbas,248 :: 		Jmonth = Temp3 + 1
	LDS        R16, _Temp3+0
	LDS        R17, _Temp3+1
	SUBI       R16, 255
	SBCI       R17, 255
	STS        _Jmonth+0, R16
	STS        _Jmonth+1, R17
;libs/milady_shamsi.mbas,249 :: 		Jday = Temp2
	LDS        R16, _Temp2+0
	LDS        R17, _Temp2+1
	STS        _Jday+0, R16
	STS        _Jday+1, R17
;libs/milady_shamsi.mbas,250 :: 		End If
L_libs/milady_shamsi_shamsi65:
	JMP        L_libs/milady_shamsi_shamsi62
;libs/milady_shamsi.mbas,251 :: 		Else
L_libs/milady_shamsi_shamsi61:
;libs/milady_shamsi.mbas,252 :: 		Temp2 = Temp1 - 186
	LDS        R16, _Temp1+0
	LDS        R17, _Temp1+1
	SUBI       R16, 186
	SBCI       R17, 0
	STS        _Temp2+0, R16
	STS        _Temp2+1, R17
;libs/milady_shamsi.mbas,253 :: 		Temp3 = Temp2 Mod 30
	LDI        R20, 30
	LDI        R21, 0
	CALL       _Div_16x16_S+0
	MOVW       R16, R24
	STS        _Temp3+0, R16
	STS        _Temp3+1, R17
;libs/milady_shamsi.mbas,254 :: 		Temp4 = Temp2 / 30
	LDI        R20, 30
	LDI        R21, 0
	LDS        R16, _Temp2+0
	LDS        R17, _Temp2+1
	...
	STS        _Temp4+0, R16
	STS        _Temp4+1, R17
;libs/milady_shamsi.mbas,255 :: 		If Temp3 = 0 Then
	LDS        R16, _Temp3+0
	LDS        R17, _Temp3+1
	CPI        R17, 0
...
;libs/milady_shamsi.mbas,256 :: 		Jmonth = Temp4 + 6
	LDS        R16, _Temp4+0
	LDS        R17, _Temp4+1
	SUBI       R16, 250
	SBCI       R17, 255
	STS        _Jmonth+0, R16
	STS        _Jmonth+1, R17
;libs/milady_shamsi.mbas,257 :: 		Jday = 30
	LDI        R27, 30
	STS        _Jday+0, R27
	LDI        R27, 0
	STS        _Jday+1, R27
	JMP        L_libs/milady_shamsi_shamsi68
;libs/milady_shamsi.mbas,258 :: 		Else
L_libs/milady_shamsi_shamsi67:
;libs/milady_shamsi.mbas,259 :: 		Jmonth = Temp4 + 7
	LDS        R16, _Temp4+0
	LDS        R17, _Temp4+1
	SUBI       R16, 249
	SBCI       R17, 255
	STS        _Jmonth+0, R16
	STS        _Jmonth+1, R17
;libs/milady_shamsi.mbas,260 :: 		Jday = Temp3
	LDS        R16, _Temp3+0
	LDS        R17, _Temp3+1
	STS        _Jday+0, R16
	STS        _Jday+1, R17
;libs/milady_shamsi.mbas,261 :: 		End If
L_libs/milady_shamsi_shamsi68:
;libs/milady_shamsi.mbas,262 :: 		End If
...
;libs/milady_shamsi.mbas,264 :: 		Jyear = Gyear - 622
	LDS        R16, _Gyear+0
	LDS        R17, _Gyear+1
	SUBI       R16, 110
	SBCI       R17, 2
	STS        _Jyear+0, R16
	STS        _Jyear+1, R17
;libs/milady_shamsi.mbas,265 :: 		If Isleapyearp  Then
	LDS        R27, _Isleapyearp+0
	SBRS       R27, BitPos(_Isleapyearp+0)
	JMP        L_libs/milady_shamsi_shamsi70
;libs/milady_shamsi.mbas,266 :: 		Gdayofyear = Gdayofyear + 11
	LDS        R16, _Gdayofyear+0
	LDS        R17, _Gdayofyear+1
	SUBI       R16, 245
	SBCI       R17, 255
...
;libs/milady_shamsi.mbas,267 :: 		Else
L_libs/milady_shamsi_shamsi70:
;libs/milady_shamsi.mbas,268 :: 		Gdayofyear = Gdayofyear + 10
	LDS        R16, _Gdayofyear+0
	LDS        R17, _Gdayofyear+1
	SUBI       R16, 246
	SBCI       R17, 255
	STS        _Gdayofyear+0, R16
	STS        _Gdayofyear+1, R17
;libs/milady_shamsi.mbas,269 :: 		End If
L_libs/milady_shamsi_shamsi71:
;libs/milady_shamsi.mbas,270 :: 		Temp2 = Gdayofyear Mod 30
	LDI        R20, 30
	LDI        R21, 0
	LDS        R16, _Gdayofyear+0
	LDS        R17, _Gdayofyear+1
	...
	STS        _Temp2+0, R16
	STS        _Temp2+1, R17
;libs/milady_shamsi.mbas,271 :: 		Temp3 = Gdayofyear / 30
	LDI        R20, 30
	LDI        R21, 0
	LDS        R16, _Gdayofyear+0
	LDS        R17, _Gdayofyear+1
	...
	STS        _Temp3+0, R16
	STS        _Temp3+1, R17
;libs/milady_shamsi.mbas,272 :: 		If Temp2 = 0 Then
	LDS        R16, _Temp2+0
	LDS        R17, _Temp2+1
	CPI        R17, 0
...
;libs/milady_shamsi.mbas,273 :: 		Jmonth = Temp3 + 9
	LDS        R16, _Temp3+0
	LDS        R17, _Temp3+1
	SUBI       R16, 247
	SBCI       R17, 255
...
;libs/milady_shamsi.mbas,276 :: 		Jmonth = Temp3 + 10
	LDS        R16, _Temp3+0
	LDS        R17, _Temp3+1
	SUBI       R16, 246
	SBCI       R17, 255
	STS        _Jmonth+0, R16
	STS        _Jmonth+1, R17
;libs/milady_shamsi.mbas,277 :: 		Jday = Temp2
	LDS        R16, _Temp2+0
	LDS        R17, _Temp2+1
	STS        _Jday+0, R16
	STS        _Jday+1, R17
...
L_libs/milady_shamsi_shamsi75:
	...
	DEC        R17
	BRNE       L_libs/milady_shamsi_shamsi75
;libs/milady_shamsi.mbas,280 :: 		End If
L_libs/milady_shamsi_shamsi59:
;libs/milady_shamsi.mbas,282 :: 		end sub
L_end_shamsi:
	RET
...
;libs/milady_shamsi.mbas,283 :: 		sub procedure miladi_call(dim jjmonth,jjday,jjyear,jweek,jhours ,jminutes,jseconds as integer)
	PUSH       R2
	PUSH       R3
	PUSH       R4
	PUSH       R5
	...
	STD        Y+4, R16
	STD        Y+5, R17
;libs/milady_shamsi.mbas,286 :: 		Lcd_0()
	PUSH       R9
	PUSH       R8
	PUSH       R7
	PUSH       R6
	...
	POP        R6
	POP        R7
;libs/milady_shamsi.mbas,287 :: 		shamsi_to_milady( jjmonth, jjday, jJyear )
...
;libs/milady_shamsi.mbas,305 :: 		LCD_Out(1,1, txt)
	...
	MOV        R2, R27
	CALL       _Lcd_Out+0
;libs/milady_shamsi.mbas,306 :: 		Lcd_Chr(1, 6, (miladiDate_iDay div 10)   + 48)    ' Print tens digit of day variable
	LDI        R20, 10
	LDI        R21, 0
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,307 :: 		Lcd_Chr(1, 7, (miladiDate_iDay mod 10)   + 48)    ' Print oness digit of day variable
	LDI        R20, 10
	LDI        R21, 0
	LDS        R16, _miladiDate_iDay+0
	LDS        R17, _miladiDate_iDay+1
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,308 :: 		Lcd_Chr(1, 9, (miladiDate_iMonth div 10) + 48)
	LDI        R20, 10
	LDI        R21, 0
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,309 :: 		Lcd_Chr(1,10, (miladiDate_iMonth mod 10) + 48)
	LDI        R20, 10
	LDI        R21, 0
	LDS        R16, _miladiDate_iMonth+0
	LDS        R17, _miladiDate_iMonth+1
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,310 :: 		Lcd_Chr(1,12, (miladiDate_iYear div 1000)  + 48)
	LDI        R20, 232
	LDI        R21, 3
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,311 :: 		Lcd_Chr(1,13, ((miladiDate_iYear mod 1000)div 100)  + 48)
	LDI        R20, 232
	LDI        R21, 3
	LDS        R16, _miladiDate_iYear+0
	LDS        R17, _miladiDate_iYear+1
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,312 :: 		Lcd_Chr(1,14, (((miladiDate_iYear mod 1000)mod 100) div 10)  + 48)
	LDI        R20, 232
	LDI        R21, 3
	LDS        R16, _miladiDate_iYear+0
	LDS        R17, _miladiDate_iYear+1
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,313 :: 		Lcd_Chr(1,15, (((miladiDate_iYear mod 1000)mod 100) mod 10)  + 48)
	LDI        R20, 232
	LDI        R21, 3
	LDS        R16, _miladiDate_iYear+0
	LDS        R17, _miladiDate_iYear+1
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,315 :: 		Lcd_Chr(2, 6, (jhours div 10)   + 48)
	LDI        R20, 10
	LDI        R21, 0
	LDD        R16, Y+0
	LDD        R17, Y+1
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,316 :: 		Lcd_Chr(2, 7, (jhours mod 10)   + 48)
	LDI        R20, 10
	LDI        R21, 0
	LDD        R16, Y+0
	LDD        R17, Y+1
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,317 :: 		Lcd_Chr(2, 9, (jminutes div 10) + 48)
	LDI        R20, 10
	LDI        R21, 0
	LDD        R16, Y+2
	LDD        R17, Y+3
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,318 :: 		Lcd_Chr(2,10, (jminutes mod 10) + 48)
	LDI        R20, 10
	LDI        R21, 0
	LDD        R16, Y+2
	LDD        R17, Y+3
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,319 :: 		Lcd_Chr(2,12, (jseconds div 10) + 48)
	LDI        R20, 10
	LDI        R21, 0
	LDD        R16, Y+4
	LDD        R17, Y+5
	...
	MOV        R2, R27
	CALL       _Lcd_Chr+0
;libs/milady_shamsi.mbas,320 :: 		Lcd_Chr(2,13, (jseconds mod 10) + 48)
	LDI        R20, 10
	LDI        R21, 0
	LDD        R16, Y+4
	LDD        R17, Y+5
...
;libs/milady_shamsi.mbas,332 :: 		Gyear =  Year+2000
	LDS        R16, _year+0
	LDI        R17, 0
	SUBI       R16, 48
	SBCI       R17, 248
	STS        _Gyear+0, R16
	STS        _Gyear+1, R17
;libs/milady_shamsi.mbas,333 :: 		Gday = Day
	LDS        R16, _day+0
	STS        _Gday+0, R16
	LDI        R27, 0
	STS        _Gday+1, R27
;libs/milady_shamsi.mbas,334 :: 		Gmonth = Month
	LDS        R16, _month+0
	STS        _Gmonth+0, R16
	LDI        R27, 0
	STS        _Gmonth+1, R27
;libs/milady_shamsi.mbas,336 :: 		shamsi()
	CALL       libs/milady_shamsi_shamsi+0
;libs/milady_shamsi.mbas,342 :: 		Lcd_Cmd(_LCD_CLEAR)               ' Prepare and output static text on LCD
	LDI        R27, 1
	MOV        R2, R27
	CALL       _Lcd_Cmd+0
;libs/milady_shamsi.mbas,351 :: 		end sub
L_end_Shamsi_call:
	POP        R2
	RET
; end of _Shamsi_call
...
;libs/milady_shamsi.mbas,353 :: 		end.
