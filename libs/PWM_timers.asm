...
;libs/PWM_timers.mbas,378 :: 		ASSR=0x00
	...
	LDI        R27, 0
	OUT        ASSR+0, R27
;libs/PWM_timers.mbas,393 :: 		TCCR2 = (1<<FOC2)or(1<<COM01)or(0<<COM00)or(1<<WGM00) or(0<<WGM01)or(1<<CS00) or(0<<CS01) or(1<<CS02) or (0<<WGM21)
	LDI        R27, 229
	OUT        TCCR2+0, R27
;libs/PWM_timers.mbas,394 :: 		TCNT2=0x00
	LDI        R27, 0
	OUT        TCNT2+0, R27
;libs/PWM_timers.mbas,395 :: 		ocr2=0x00
	LDI        R27, 0
	OUT        OCR2+0, R27
;libs/PWM_timers.mbas,400 :: 		PWM16bit_Init(_PWM16_PHASE_CORRECT_MODE_8BIT, _PWM16_PRESCALER_16bit_8, _PWM16_NON_INVERTED, 0, _TIMER1)
	LDI        R27, 1
	MOV        R7, R27
	CLR        R5
	CLR        R6
...
;libs/PWM_timers.mbas,440 :: 		end sub
...
;libs/PWM_timers.mbas,444 :: 		k as byte
;libs/PWM_timers.mbas,445 :: 		J=0
	PUSH       R2
	PUSH       R3
	PUSH       R4
	PUSH       R5
	LDI        R27, 0
	STD        Y+0, R27
;libs/PWM_timers.mbas,456 :: 		TCCR0=(1<<WGM00) or (1<<COM01) or (1<<COM00) or (1<<WGM01) or (1<<CS02) or (0<<CS01) or (1<<CS00)
	LDI        R27, 125
	OUT        TCCR0+0, R27
;libs/PWM_timers.mbas,457 :: 		TCNT0=0x00
	LDI        R27, 0
	OUT        TCNT0+0, R27
;libs/PWM_timers.mbas,471 :: 		TCCR1A=0xA1
	LDI        R27, 161
	OUT        TCCR1A+0, R27
;libs/PWM_timers.mbas,472 :: 		TCCR1B=0x05
	LDI        R27, 5
	OUT        TCCR1B+0, R27
;libs/PWM_timers.mbas,473 :: 		TCNT1H=0x00
	LDI        R27, 0
	OUT        TCNT1H+0, R27
;libs/PWM_timers.mbas,474 :: 		TCNT1L=0x00
	LDI        R27, 0
	OUT        TCNT1L+0, R27
;libs/PWM_timers.mbas,475 :: 		ICR1H=0x00
	LDI        R27, 0
	OUT        ICR1H+0, R27
;libs/PWM_timers.mbas,476 :: 		ICR1L=0x00
	LDI        R27, 0
	OUT        ICR1L+0, R27
;libs/PWM_timers.mbas,477 :: 		OCR1AH=0x00
	LDI        R27, 0
	OUT        OCR1AH+0, R27
;libs/PWM_timers.mbas,478 :: 		OCR1AL=0x11
	LDI        R27, 17
	OUT        OCR1AL+0, R27
;libs/PWM_timers.mbas,479 :: 		OCR1BH=0x00
	LDI        R27, 0
	OUT        OCR1BH+0, R27
;libs/PWM_timers.mbas,480 :: 		OCR1BL=0x12
	LDI        R27, 18
	OUT        OCR1BL+0, R27
;libs/PWM_timers.mbas,493 :: 		ocr0=0 ocr2=0
	LDI        R27, 0
	OUT        OCR0+0, R27
	LDI        R27, 0
	OUT        OCR2+0, R27
;libs/PWM_timers.mbas,495 :: 		PWM1_Init(_PWM1_FAST_MODE, _PWM1_PRESCALER_8, _PWM1_NON_INVERTED, 127)''PWM1_Init(5000)'' Initialize PWM1
	LDI        R27, 127
	MOV        R5, R27
	LDI        R27, 32
	MOV        R4, R27
	...
	MOV        R2, R27
	CALL       _PWM1_Init+0
;libs/PWM_timers.mbas,499 :: 		PWM1_Start()'' start PWM1
	CALL       _PWM1_Start+0
;libs/PWM_timers.mbas,502 :: 		PWM1_Set_Duty(j)''Set current duty for PWM1
	LDD        R2, Y+0
	CALL       _PWM1_Set_Duty+0
;libs/PWM_timers.mbas,504 :: 		ASSR=0x00
	LDI        R27, 0
	OUT        ASSR+0, R27
;libs/PWM_timers.mbas,505 :: 		TCCR2=0x27
	LDI        R27, 39
	OUT        TCCR2+0, R27
;libs/PWM_timers.mbas,506 :: 		TCNT2=0x00
	LDI        R27, 0
	OUT        TCNT2+0, R27
;libs/PWM_timers.mbas,507 :: 		for k=10 to 0  step -1
	LDI        R27, 10
	STD        Y+1, R27
L_libs/PWM_timers_PWM_Initialize_old61:
;libs/PWM_timers.mbas,508 :: 		PWM_MAKE (k*10,255,1)''(dim jj as byte,dim max_duty,Pwm_chanel as integer)
	LDD        R17, Y+1
	LDI        R16, 10
	MUL        R17, R16
	MOV        R16, R0
	...
	MOV        R2, R16
	CALL       _PWM_MAKE+0
;libs/PWM_timers.mbas,509 :: 		PWM_MAKE (k*10,255,2)''(dim jj as byte,dim max_duty,Pwm_chanel as integer)
	LDD        R17, Y+1
	LDI        R16, 10
	MUL        R17, R16
	MOV        R16, R0
	...
	MOV        R2, R16
	CALL       _PWM_MAKE+0
;libs/PWM_timers.mbas,510 :: 		PWM_MAKE (k*10,255,3)''(dim jj as byte,dim max_duty,Pwm_chanel as integer)
	LDD        R17, Y+1
	LDI        R16, 10
	MUL        R17, R16
	MOV        R16, R0
	...
	MOV        R2, R16
	CALL       _PWM_MAKE+0
;libs/PWM_timers.mbas,511 :: 		PWM_MAKE (k*10,255,4)''(dim jj as byte,dim max_duty,Pwm_chanel as integer)
	LDD        R17, Y+1
	LDI        R16, 10
	MUL        R17, R16
	MOV        R16, R0
	...
	MOV        R2, R16
	CALL       _PWM_MAKE+0
;libs/PWM_timers.mbas,512 :: 		delay_ms(10)
	LDI        R17, 208
	LDI        R16, 202
L_libs/PWM_timers_PWM_Initialize_old65:
	DEC        R16
	BRNE       L_libs/PWM_timers_PWM_Initialize_old65
	DEC        R17
	BRNE       L_libs/PWM_timers_PWM_Initialize_old65
	NOP
;libs/PWM_timers.mbas,513 :: 		next k
	LDD        R16, Y+1
	CPI        R16, 0
	BRNE       L_libs/PWM_timers_PWM_Initialize_old131
	JMP        L_libs/PWM_timers_PWM_Initialize_old64
L_libs/PWM_timers_PWM_Initialize_old131:
	LDD        R16, Y+1
	SUBI       R16, 1
	STD        Y+1, R16
	JMP        L_libs/PWM_timers_PWM_Initialize_old61
L_libs/PWM_timers_PWM_Initialize_old64:
;libs/PWM_timers.mbas,514 :: 		PWM_MAKE (0,255,4)''(dim jj as byte,dim max_duty,Pwm_chanel as integer)
	LDI        R27, 4
	MOV        R4, R27
	LDI        R27, 255
	MOV        R3, R27
	CLR        R2
	CALL       _PWM_MAKE+0
;libs/PWM_timers.mbas,534 :: 		end sub
...
;libs/PWM_timers.mbas,539 :: 		Lcd_0() lcd_out(1,1,"Initialsiing Heater")
	PUSH       R5
	PUSH       R4
	PUSH       R3
	PUSH       R2
...
;libs/PWM_timers.mbas,540 :: 		delay_ms(100)
	...
	LDI        R17, 30
	LDI        R16, 229
L__On_mSec_initial_heater68:
	DEC        R16
	BRNE       L__On_mSec_initial_heater68
	DEC        R17
	BRNE       L__On_mSec_initial_heater68
	DEC        R18
	BRNE       L__On_mSec_initial_heater68
	NOP
;libs/PWM_timers.mbas,541 :: 		for chanel_ini =1 to Choice_number
	LDI        R27, 1
	STD        Y+1, R27
L__On_mSec_initial_heater71:
;libs/PWM_timers.mbas,542 :: 		for Heater_Motor_Time_ini=1 to 2 ''Heater
	LDI        R27, 1
	STD        Y+2, R27
L__On_mSec_initial_heater76:
;libs/PWM_timers.mbas,543 :: 		for Pwm_chanel_ini =1 to 3
	LDI        R27, 1
	STD        Y+0, R27
...
;libs/PWM_timers.mbas,550 :: 		next Pwm_chanel_ini
	LDD        R16, Y+0
	CPI        R16, 3
	BRNE       L__On_mSec_initial_heater133
	JMP        L__On_mSec_initial_heater84
L__On_mSec_initial_heater133:
	LDD        R16, Y+0
	SUBI       R16, 255
	STD        Y+0, R16
...
;libs/PWM_timers.mbas,551 :: 		next Heater_Motor_Time_ini
	LDD        R16, Y+2
	CPI        R16, 2
	BRNE       L__On_mSec_initial_heater134
	JMP        L__On_mSec_initial_heater79
L__On_mSec_initial_heater134:
	LDD        R16, Y+2
	SUBI       R16, 255
	STD        Y+2, R16
...
;libs/PWM_timers.mbas,552 :: 		next chanel_ini
	...
	JMP        L__On_mSec_initial_heater74
L__On_mSec_initial_heater135:
	LDD        R16, Y+1
	SUBI       R16, 255
	STD        Y+1, R16
	JMP        L__On_mSec_initial_heater71
L__On_mSec_initial_heater74:
...
;libs/PWM_timers.mbas,556 :: 		dim Pwm_chanel_ini,chanel_ini,Heater_Motor_Time_ini as byte
;libs/PWM_timers.mbas,557 :: 		Lcd_0() lcd_out(1,1,"Initialsiing Motor")
	PUSH       R5
	PUSH       R4
	PUSH       R3
	PUSH       R2
	...
	POP        R4
	POP        R5
;libs/PWM_timers.mbas,558 :: 		delay_ms(100)
	LDI        R18, 9
	LDI        R17, 30
	LDI        R16, 229
L__On_mSec_initial_Motor86:
	DEC        R16
	BRNE       L__On_mSec_initial_Motor86
	DEC        R17
	BRNE       L__On_mSec_initial_Motor86
	DEC        R18
	BRNE       L__On_mSec_initial_Motor86
	NOP
;libs/PWM_timers.mbas,559 :: 		for chanel_ini =1 to Choice_number
	LDI        R27, 1
	STD        Y+1, R27
L__On_mSec_initial_Motor89:
;libs/PWM_timers.mbas,560 :: 		for Heater_Motor_Time_ini=2 to 2 ''Motor
	LDI        R27, 2
	STD        Y+2, R27
L__On_mSec_initial_Motor94:
;libs/PWM_timers.mbas,561 :: 		for Pwm_chanel_ini =2 to 3
	LDI        R27, 2
	STD        Y+0, R27
L__On_mSec_initial_Motor99:
;libs/PWM_timers.mbas,562 :: 		Mot_heater_On_mSec [chanel_ini-1][Heater_Motor_Time_ini-1][Pwm_chanel_ini-1][0] =en
	LDD        R16, Y+1
	SUBI       R16, 1
	LDI        R17, 0
	LDI        R20, 24
	...
	ADC        R31, R19
	ST         Z, R2
;libs/PWM_timers.mbas,563 :: 		Mot_heater_On_mSec [chanel_ini-1][Heater_Motor_Time_ini-1][Pwm_chanel_ini-1][1]=mint
	LDD        R16, Y+1
	SUBI       R16, 1
	LDI        R17, 0
	LDI        R20, 24
	...
	ADIW       R30, 1
	ST         Z, R3
;libs/PWM_timers.mbas,564 :: 		Mot_heater_On_mSec [chanel_ini-1][Heater_Motor_Time_ini-1][Pwm_chanel_ini-1][2] =sec+chanel_ini
	LDD        R16, Y+1
	SUBI       R16, 1
	LDI        R17, 0
	LDI        R20, 24
	...
	ADD        R16, R4
	ST         Z, R16
;libs/PWM_timers.mbas,565 :: 		Mot_heater_On_mSec [chanel_ini-1][Heater_Motor_Time_ini-1][Pwm_chanel_ini-1][3]=prc
	LDD        R16, Y+1
	SUBI       R16, 1
	LDI        R17, 0
	LDI        R20, 24
	...
	ADIW       R30, 3
	ST         Z, R5
;libs/PWM_timers.mbas,568 :: 		next Pwm_chanel_ini
	LDD        R16, Y+0
	CPI        R16, 3
	BRNE       L__On_mSec_initial_Motor137
	JMP        L__On_mSec_initial_Motor102
L__On_mSec_initial_Motor137:
	LDD        R16, Y+0
	SUBI       R16, 255
	STD        Y+0, R16
	JMP        L__On_mSec_initial_Motor99
L__On_mSec_initial_Motor102:
;libs/PWM_timers.mbas,569 :: 		next Heater_Motor_Time_ini
	LDD        R16, Y+2
	CPI        R16, 2
	BRNE       L__On_mSec_initial_Motor138
	JMP        L__On_mSec_initial_Motor97
L__On_mSec_initial_Motor138:
	LDD        R16, Y+2
	SUBI       R16, 255
	STD        Y+2, R16
	JMP        L__On_mSec_initial_Motor94
L__On_mSec_initial_Motor97:
;libs/PWM_timers.mbas,570 :: 		next chanel_ini
	LDD        R16, Y+1
	CPI        R16, 3
	BRNE       L__On_mSec_initial_Motor139
	JMP        L__On_mSec_initial_Motor92
L__On_mSec_initial_Motor139:
	LDD        R16, Y+1
	SUBI       R16, 255
	STD        Y+1, R16
	JMP        L__On_mSec_initial_Motor89
L__On_mSec_initial_Motor92:
;libs/PWM_timers.mbas,571 :: 		end sub
...
;libs/PWM_timers.mbas,572 :: 		sub procedure  WDT_on_old()
;libs/PWM_timers.mbas,604 :: 		WDTCR =(1<<WDP2) or (1<<WDP1)  or (1<<WDP0)
	PUSH       R2
	PUSH       R3
	PUSH       R4
	PUSH       R5
	LDI        R27, 7
	OUT        WDTCR+0, R27
;libs/PWM_timers.mbas,610 :: 		Lcd_Cmd(_LCD_CLEAR)
	LDI        R27, 1
	MOV        R2, R27
	CALL       _Lcd_Cmd+0
;libs/PWM_timers.mbas,611 :: 		Lcd_Out(2,2,"Reset.")
	MOVW       R30, R28
	LDI        R27, 82
	ST         Z+, R27
	LDI        R27, 101
	...
	MOV        R2, R27
	CALL       _Lcd_Out+0
;libs/PWM_timers.mbas,617 :: 		end sub
L_end_WDT_on_old:
	POP        R5
	POP        R4
	POP        R3
